...
default =  {
    ...
    "greetings": [
      ...
      "悄悄告诉你，咖啡里藏着的全是实打实的咖啡券哦，种类多到数不清，别犹豫啦，快来试试手气，说不定下一个幸运儿就是你呢！",
      "咖啡机向你发射惊喜信号！各种咖啡兑换券都藏在咖啡里，就等您来揭开神秘面纱，把心仪的咖啡券带回家，还不赶紧来抽一波？",
      "逛街累了吧？来咖啡机前歇个脚呀，只需扫码领取验证码，就能领到超值咖啡券呢！不要错过呀！"
      ],
    "products": [
      "美式，拿铁咖啡，抹茶，苹果汁"
    ],
